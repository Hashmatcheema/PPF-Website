...
function cityLandmarkSvgIcons(iconCls: string) {
  return [
    ...
    <svg key="lhr" viewBox="0 0 48 48" className={iconCls} fill="currentColor" aria-hidden>
    ...
    <svg key="khi" viewBox="0 0 48 48" className={iconCls} fill="currentColor" aria-hidden>
    ...
    <svg key="srg" viewBox="0 0 48 48" className={iconCls} fill="currentColor" aria-hidden>
      <circle cx="24" cy="14" r="8" />
      <path d="M10,38 Q10,24 24,24 Q38,24 38,38 Z" />
      <rect x="0" y="38" width="48" height="8" />
    </svg>,
    // 5: Multan – Shrine of Rukn-e-Alam
    <svg key="mtn" viewBox="0 0 48 48" className={iconCls} fill="currentColor" aria-hidden>
