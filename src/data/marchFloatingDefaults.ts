/** Defaults for march pill + dialog; keep in sync with `content.*.floatingBar` and `server/lib/ctas.ts`. */
export const MARCH_FLOATING_DEFAULT_TITLE: { en: string; ur: string } = {
  en: "Pakistanis March For Gaza",
  ur: "غزہ کے لیے پاکستانی مارچ",
}

export const MARCH_FLOATING_DEFAULT_BODY: { en: string; ur: string } = {
